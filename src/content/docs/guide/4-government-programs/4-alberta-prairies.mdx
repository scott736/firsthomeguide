...
When you purchase a home in Alberta, instead of a percentage-based land transfer tax, you pay only a **property registration fee** to register the title and mortgage with the Land Titles Office. This fee is based on a simple formula:
...
Saskatchewan does not technically charge a "land transfer tax," but it does have **land title transfer fees** that are modest:
