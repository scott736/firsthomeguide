...
Quebec charges a [land transfer tax](/guide/7-closing-the-deal/3-land-transfer-tax/) on all property purchases, commonly called the **"welcome tax"** or *droits de mutation*. Despite its friendly-sounding nickname, the welcome tax is a mandatory closing cost that catches many first-time buyers off guard.
