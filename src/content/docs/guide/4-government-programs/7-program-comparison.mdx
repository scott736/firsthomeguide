...
These programs are available to all qualifying first-time home buyers across Canada, regardless of province:
...
| **Alberta** | **No land transfer tax** (registration fee only ~$400) | Attainable Homes Calgary (shared equity) | — | Lowest closing costs in Canada; no PST |
...
*Federal programs include: FHSA tax deductions over 5 years ($12,000 at 30% rate) + HBTC ($1,500). HBP is excluded as it is a withdrawal, not a net savings.*

---

**You now have a comprehensive picture of every federal and provincial program available to first-time home buyers in Canada. Continue to Module 5: Finding the Right Home (coming soon).**
