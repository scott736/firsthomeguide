...
For a detailed breakdown of FHSA contribution strategies, investment options, and timelines, see [Module 2: Saving Smart](/guide/saving-smart/).
...
For detailed HBP rules, repayment schedules, and strategies for combining with the FHSA, see [Module 2: Saving Smart](/guide/saving-smart/).
...
Because it is non-refundable, it can reduce your federal tax owing to zero but cannot generate a refund on its own. However, most working Canadians have enough federal tax owing that the full $1,500 benefit is realized.
...
In provinces that charge HST (Ontario, Nova Scotia, New Brunswick, Newfoundland and Labrador, PEI), there are additional **provincial HST rebates** available on new construction. These vary by province:
