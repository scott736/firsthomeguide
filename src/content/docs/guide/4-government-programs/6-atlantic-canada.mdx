...
description: "First-time home buyer programs in Atlantic Canada — Nova Scotia's interest-free 5% down payment loan, 2% pilot down payment program, New Brunswick HST rebate, PEI property transfer tax exemption, and Newfoundland assistance."
sidebar:
  order: 6
...
- **Repayment:** The loan must be repaid over **10 years**
...
### NEW: First-Time Homebuyers 2% Down Payment Program (February 2026)

Nova Scotia became the **first province in Canada** to reduce the minimum down payment below the national 5% standard. Launched **February 3, 2026**, this pilot program is administered jointly by the provincial government, Atlantic Central, and participating credit unions.

**Key details:**

- **Minimum down payment:** **2%** of the purchase price (versus the national minimum of 5%)
- **Price caps:** $570,000 in Halifax Regional Municipality and Municipality of East Hants; $500,000 in all other areas of Nova Scotia
- **Household income limit:** $200,000 or less
- **Credit score requirement:** 630 or higher
- **Stress test:** You must qualify under the standard mortgage stress test
- **No mortgage default insurance required** under this pilot (unlike standard insured mortgages)
- **Interest rate:** Capped at prime + 2%
- **Who qualifies:** First-time buyers, including those who have not owned a home in the past four years
- **Where to apply:** Through participating credit unions in Nova Scotia

**Example: $400,000 home in Halifax under the 2% program**
- Minimum down payment: $400,000 x 2% = **$8,000**
- Compare to national minimum (5%): $400,000 x 5% = $20,000
- **Savings vs. standard minimum: $12,000**

This pilot is particularly powerful when combined with the DPAP interest-free loan — you may be able to structure the down payment with minimal personal savings, freeing up cash for closing costs and an emergency fund. Check current program availability and eligibility directly with participating NS credit unions.

### Nova Scotia HST Rebate on New Homes

Buyers of newly constructed homes in Nova Scotia may be eligible for a rebate on the **provincial portion of the HST**. Effective **April 1, 2025**, Nova Scotia reduced its HST rate by one percentage point, so the current HST rate is **14%** (5% federal + 9% provincial).
...
PEI normally charges a Real Property Transfer Tax of **1% of the greater of the purchase price or the assessed value** (with a higher 2% rate on the portion of value exceeding $1,000,000, introduced April 28, 2025). First-time home buyers are **fully exempt** from this tax on qualifying purchases.
...
- Note: For properties priced above $1,000,000, the 2% rate applies to the portion over $1M even for first-time buyers — the exemption only covers the standard 1% portion
