...
description: "Complete guide to buying a pre-construction or newly built home in Canada — deposits, warranties, HST, timelines, the new First-Time Home Buyers' GST/HST Rebate, and what to watch for."
sidebar:
  order: 7
...
:::caution
Do not sign a pre-construction purchase agreement without having it reviewed by a **[real estate lawyer](/guide/7-closing-the-deal/4-real-estate-lawyer/)** — not just a real estate agent. The legal and financial implications of these contracts are significant, and a lawyer can identify problematic clauses (particularly around sunset clauses, assignment restrictions, and development charge caps) that could cost you tens of thousands of dollars.
:::
...
In Ontario, [Tarion Warranty Corporation](https://www.tarion.com) provides **deposit protection** for pre-construction purchases. The protection limits are:
...
:::tip
Keep your total deposits within [Tarion's](https://www.tarion.com) protection limits whenever possible. If the developer requires deposits exceeding the insured amount, discuss the risk with your lawyer and consider whether the purchase is worth the additional exposure.
:::
...
### First-Time Home Buyers' GST/HST Rebate (Now in Effect)

The federal **First-Time Home Buyers' GST/HST Rebate** received [Royal Assent on March 12, 2026](https://www.canada.ca/en/revenue-agency/news/newsroom/tax-tips/tax-tips-2026/first-time-buyers-can-save-more-on-new-homes-the-first-time-home-buyers-gst-hst-rebate-is-available-now.html) and the CRA started accepting applications on **March 17, 2026**. Eligible first-time buyers of new-build homes can recover up to **$50,000** of GST (or the federal portion of HST):

- **Full rebate** on new homes priced up to **$1 million**
- **Phased out** between $1 million and $1.5 million
- **No rebate** on homes priced at $1.5 million or more
- Applies to purchase agreements entered into between **March 20, 2025 and before 2031**

Ontario has announced its intention to also rebate the full **8% provincial portion of HST** on qualifying first-time buyer new builds, which would push combined federal + Ontario savings to roughly **$130,000** on a new build under $1 million. As of April 2026, the federal portion is law; the Ontario provincial component requires separate provincial legislation. Confirm the status with your lawyer or builder before signing.

### Provincial Rebates

Several provinces offer their own rebates on top of the federal rebate. For province-specific details, see our guides to [Ontario government programs](/guide/4-government-programs/2-ontario/) and [British Columbia government programs](/guide/4-government-programs/3-british-columbia/):
...
### Ontario: [Tarion Warranty Corporation](https://www.tarion.com)

[Tarion](https://www.tarion.com) is the mandatory warranty provider for all new homes built in Ontario. Every new home comes with three levels of coverage:
...
**How to make a claim:** Submit your claim through [Tarion's online portal](https://www.tarion.com) within the applicable warranty period. You must first give the builder a chance to fix the issue (with a reasonable timeline). If the builder does not resolve it, Tarion steps in to assess and potentially resolve the claim. Document everything with photos and written correspondence.
...
If a builder goes bankrupt before completing the project, your deposits are at risk above and beyond the warranty protection limits. In Ontario, [Tarion](https://www.tarion.com) protects deposits up to $60,000 on homes priced at $600,000 or less. In other provinces, check the applicable deposit protection rules. If you have paid $100,000 in deposits on a $500,000 unit and the builder goes under, you could potentially lose $40,000 or more.
...
- [ ] Confirmed the total purchase price, including whether HST is included or excluded, and reviewed how [closing costs on new builds](/guide/7-closing-the-deal/1-closing-costs-overview/) differ from resale
...
<KnowledgeQuiz
  client:visible
  moduleNumber={5}
  moduleName="Finding a Home"
  questions={[
    {
      question: "What is a buyer's agent legally required to do?",
      options: ["Find you the cheapest home", "Act in your best interest (fiduciary duty)", "Negotiate the lowest price", "Pay for the home inspection"],
      correctIndex: 1,
      explanation: "A buyer's agent has a fiduciary duty to act in your best interest, maintain confidentiality, and disclose material facts."
    },
    {
      question: "What is a status certificate?",
      options: ["A building permit", "A condo corporation's financial and legal snapshot", "A property tax assessment", "A home warranty document"],
      correctIndex: 1,
      explanation: "A status certificate provides a snapshot of the condo corporation's legal, financial, and operational health."
    },
    {
      question: "What is a sunset clause in pre-construction?",
      options: ["A deadline to move in", "A provision allowing contract cancellation if conditions aren't met", "A warranty expiry date", "A fixed closing date"],
      correctIndex: 1,
      explanation: "A sunset clause allows the developer (and sometimes the buyer) to cancel if conditions aren't met by a specific date."
    },
  ]}
/>

<MilestoneCelebration client:visible moduleNumber={5} moduleName="Finding a Home" totalModules={8} nextModuleHref="/guide/6-making-an-offer/1-purchase-agreement/" nextModuleName="Making an Offer" />

---

**Sources:** [Tarion Warranty Corporation](https://www.tarion.com) · [CMHC — Home Buying](https://www.cmhc-schl.gc.ca/consumers/home-buying) · [CMHC — Mortgage Loan Insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance) · [BCFSA — BC Financial Services Authority](https://www.bcfsa.ca)
