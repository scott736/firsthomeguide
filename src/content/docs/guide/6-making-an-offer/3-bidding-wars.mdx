...
The listing agent may tell you how many **registered offers** there are (in Ontario, agents are now [required by RECO](https://www.reco.on.ca) to disclose the number of competing offers when asked), but they cannot reveal the details of any offer. This means you are bidding without knowing whether you are competing against one other buyer or twenty, or whether competing offers are conditional or firm.
...
Sellers take offers more seriously when they know your financing is solid. Have a current [pre-approval letter](/guide/3-down-payments-mortgages/5-pre-approval/) from your lender (see [FCAC's mortgage guidance](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) for what to expect), and make sure your mortgage broker is aware you are actively making offers so they can respond quickly if needed.
