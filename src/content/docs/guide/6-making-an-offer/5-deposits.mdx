...
- **The deposit is delivered to the listing brokerage's trust account** or, in some cases, directly to a [lawyer's trust account](/guide/7-closing-the-deal/4-real-estate-lawyer/). It is held in trust and cannot be used by anyone until the deal closes or is terminated.
