...
- **Appraise the property** — If the appraisal comes in below your purchase price, the lender will only approve a mortgage based on the lower appraised value (this is a standard requirement under [CMHC mortgage insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance) and [OSFI guidelines](https://www.osfi-bsif.gc.ca/en/guidance/guidance-library/residential-mortgage-underwriting-practices-procedures)). For example, you offered $550,000 but the property appraises at $510,000. On a 20% down payment, the lender will approve a mortgage of $408,000 (80% of $510,000) instead of $440,000 (80% of $550,000). You would need to come up with an **extra $32,000 in cash** — money you may not have.
...
:::caution
Before waiving the financing condition, speak with your mortgage broker and ask them point-blank: "Are you confident this specific property will be approved, and is there any scenario where the mortgage could be declined?" See [FCAC's mortgage guidance](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) for more on what lenders evaluate. If there is any uncertainty, keep the condition. No house is worth risking your financial future.
:::
...
Many first-time buyers focus entirely on the down payment and forget that [closing costs](/guide/7-closing-the-deal/1-closing-costs-overview/) can add **$10,000 to $30,000 or more** to the total cash required on closing day.

### Common Closing Costs in Canada

| Cost | Typical Amount |
|---|---|
| [Land transfer tax](/guide/7-closing-the-deal/3-land-transfer-tax/) (provincial) | 0.5% - 2% of purchase price |
...
Shopping without a [pre-approval](/guide/3-down-payments-mortgages/5-pre-approval/) means you do not know what you can actually afford. You waste time viewing homes outside your budget, and when you find one you want, you scramble to arrange financing while competing against prepared buyers.
...
<KnowledgeQuiz
  client:visible
  moduleNumber={6}
  moduleName="Making an Offer"
  questions={[
    {
      question: "What makes an offer 'firm'?",
      options: ["It's been signed by the seller", "All conditions have been fulfilled or waived", "The deposit has been paid", "The lawyer has reviewed it"],
      correctIndex: 1,
      explanation: "An offer becomes firm when all conditions are fulfilled or waived, legally binding both parties."
    },
    {
      question: "How much deposit is typical for a resale home in Canada?",
      options: ["$500", "1-5% of purchase price", "10% of purchase price", "First month's mortgage"],
      correctIndex: 1,
      explanation: "Deposits for resale transactions are typically 1-5% of the purchase price."
    },
    {
      question: "What is the irrevocability period?",
      options: ["The mortgage lock-in term", "Time during which an offer cannot be withdrawn", "The home inspection window", "The closing period"],
      correctIndex: 1,
      explanation: "The irrevocability period is the window during which your offer cannot be retracted."
    },
  ]}
/>

<MilestoneCelebration client:visible moduleNumber={6} moduleName="Making an Offer" totalModules={8} nextModuleHref="/guide/7-closing-the-deal/1-closing-costs-overview/" nextModuleName="Closing the Deal" />

---

**Sources:** [FCAC — Mortgages](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) · [CMHC — Mortgage Loan Insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance) · [OSFI — Mortgage Underwriting Guidelines](https://www.osfi-bsif.gc.ca/en/guidance/guidance-library/residential-mortgage-underwriting-practices-procedures) · [CMHC — Home Buying](https://www.cmhc-schl.gc.ca/consumers/home-buying)

---

**Next: [Closing the Deal](/guide/7-closing-the-deal/1-closing-costs-overview/)**
