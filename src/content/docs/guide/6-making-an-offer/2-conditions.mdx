...
If you are buying a [condominium](/guide/5-finding-a-home/3-condo-vs-freehold/), the status certificate condition gives your lawyer time to review the condo corporation's status certificate (in Ontario) or Form B Information Certificate (in BC). This review typically requires **5 to 10 business days**.
