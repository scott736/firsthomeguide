...
When your offer is accepted, the condition period clock starts immediately. Your offer will also include an <GlossaryTooltip client:load term="irrevocability" definition="The period during which a submitted offer cannot be withdrawn or changed by the buyer." /> period — the window during which the seller can consider and respond to your offer. Each condition has its own deadline, specified in the agreement. For example:
