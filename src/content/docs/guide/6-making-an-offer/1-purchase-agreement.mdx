...
In most of Canada, the APS follows a standardized form provided by the local real estate board. In Ontario, the Ontario Real Estate Association (OREA) form is the standard, regulated by [RECO](https://www.reco.on.ca). In British Columbia, the standard form is provided by the BC Real Estate Association. While the forms vary by province, the core elements are consistent.
...
Contingencies that must be satisfied before the deal becomes firm and binding. Common conditions include [financing approval](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html), satisfactory home inspection, and review of the status certificate (for condos). Conditions are [covered in detail in the next section](/guide/6-making-an-offer/2-conditions/).
...
<WhatsNext client:visible items={[
  { title: "Understanding Conditions", description: "Learn about financing, inspection, and other protective conditions", href: "/guide/6-making-an-offer/2-conditions/", type: "guide" },
  { title: "Document Checklist", description: "Make sure you have everything ready for your offer", href: "/tools/document-checklist", type: "tool" },
  { title: "Book a Free Call", description: "Get guidance on making a competitive offer", href: "/book-a-call", type: "action" }
]} />

---

**Sources:** [RECO — Real Estate Council of Ontario](https://www.reco.on.ca) · [FCAC — Mortgages](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) · [CMHC — Home Buying](https://www.cmhc-schl.gc.ca/consumers/home-buying)
