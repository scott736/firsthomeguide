...
:::tip
Discuss your ownership structure with a real estate lawyer before closing. The wrong choice can create tax complications, estate disputes, and headaches that are expensive to unwind later. Your lawyer can also explain how your province's land titles system handles each structure.
:::
...
- **Credit score matters -- and lenders use the lower one.** Most lenders use the lower credit score (or the lower median score if pulling from multiple bureaus) to determine the interest rate. If you have a score of 780 but your co-buyer has 640, you may face a higher rate -- or struggle to qualify with certain lenders.
