...
Using [Ontario's tiered rates](/guide/7-closing-the-deal/3-land-transfer-tax/) on a $500,000 purchase:
...
- [ ] [First-time buyer rebate](https://www.ontario.ca/document/land-transfer-tax/land-transfer-tax-refunds#section-1) application completed and submitted
...
- [ ] File for the [Home Buyers' Tax Credit](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-31270-home-buyers-amount.html) ($10,000 non-refundable credit, worth up to $1,500) on your next tax return
- [ ] If you used the [Home Buyers' Plan (HBP)](/guide/2-saving-smart/2-rrsp-hbp/), set up your RRSP repayment schedule (repayments begin the second year after withdrawal, spread over 15 years)
- [ ] If you used the [First Home Savings Account (FHSA)](/guide/2-saving-smart/1-fhsa/), ensure the account is properly closed or converted after purchase
...
<KnowledgeQuiz
  client:visible
  moduleNumber={7}
  moduleName="Closing the Deal"
  questions={[
    {
      question: "What percentage of the purchase price should you budget for closing costs?",
      options: ["1-2%", "3-5%", "7-10%", "15-20%"],
      correctIndex: 1,
      explanation: "Closing costs in Canada typically total 3-5% of the purchase price."
    },
    {
      question: "What does title insurance protect against?",
      options: ["Home repairs", "Property tax increases", "Defects in property title (fraud, liens, errors)", "Mortgage rate changes"],
      correctIndex: 2,
      explanation: "Title insurance protects against defects like fraud, forgery, survey errors, unknown liens, and encroachments."
    },
    {
      question: "Who handles the legal transfer of property on closing day?",
      options: ["Your realtor", "The bank", "Your real estate lawyer", "The seller"],
      correctIndex: 2,
      explanation: "Your real estate lawyer handles all legal aspects of closing — transferring funds, registering title, and disbursing keys."
    },
  ]}
/>

<MilestoneCelebration client:visible moduleNumber={7} moduleName="Closing the Deal" totalModules={8} nextModuleHref="/guide/8-life-after-closing/1-emergency-fund/" nextModuleName="Life After Closing" />

---

**Sources:** [Ontario LTT First-Time Buyer Refund](https://www.ontario.ca/document/land-transfer-tax/land-transfer-tax-refunds#section-1) · [CRA Home Buyers' Plan](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/rrsps-related-plans/what-home-buyers-plan.html) · [CRA First Home Savings Account](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/first-home-savings-account.html) · [CMHC Mortgage Insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance)

**Next: [Your Emergency Fund](/guide/8-life-after-closing/1-emergency-fund/)**
