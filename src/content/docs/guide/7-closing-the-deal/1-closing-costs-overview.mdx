...
<AEOAnswerBox
  ...
  answer="Closing costs in Canada typically range from 3% to 5% of the purchase price, paid on top of your down payment from your own funds. On a $500,000 home, that means $15,000 to $25,000 in additional expenses that you cannot roll into your mortgage."
  bullets={[
    "Land transfer tax: varies by province (often the largest single cost)",
    "Legal fees: $1,500–$2,500",
    "Title insurance: $250–$500",
    "Home inspection: $400–$600",
    "Property tax and utility adjustments",
    "First-time buyers may get rebates on land transfer tax",
  ]}
/>
...
- **They vary by province.** [Land transfer tax](https://www.ontario.ca/document/land-transfer-tax) alone can range from zero in Alberta and Saskatchewan to over $12,000 in Toronto for a $500,000 home. Buyers who move between provinces are often shocked by the difference.
...
- **[Land transfer tax](/guide/7-closing-the-deal/3-land-transfer-tax/)** — The single largest closing cost in most provinces. This is a provincial (and sometimes municipal) tax charged when property ownership is transferred. First-time buyer rebates can offset a portion of this cost.
...
- **[Mortgage default insurance (CMHC)](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance)** — If your down payment is less than 20%, this is usually added to your mortgage balance, not paid out of pocket. But it is still a cost of buying.
...
1. **Open a separate savings account** specifically for closing costs and home setup expenses — a [Tax-Free Savings Account (TFSA)](/guide/2-saving-smart/4-tfsa/) works well for this purpose. Keep this money apart from your down payment so you know exactly where you stand.
...
:::tip[Try it yourself]
Get a personalized breakdown with our [Closing Cost Calculator](/tools/closing-cost-calculator) — enter your province, price, and property type for exact numbers.
:::

## What Is Covered in This Module

The following sub-pages break down each closing cost category in detail, including exact dollar amounts, provincial variations, and practical advice for managing each one. You can also use our [closing cost calculator](/tools/closing-cost-calculator/) to estimate your total costs based on your purchase price and province.

- **[Complete Closing Cost Breakdown](/guide/7-closing-the-deal/2-cost-breakdown/)** — A detailed look at every line item with typical cost ranges
...
**Sources:** [CMHC Homebuying Guide](https://www.cmhc-schl.gc.ca/consumers/home-buying) · [CMHC Mortgage Insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance) · [FCAC Mortgages](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) · [Ontario Land Transfer Tax](https://www.ontario.ca/document/land-transfer-tax)

<WhatsNext client:visible items={[
  { title: "Detailed Cost Breakdown", description: "See every fee you'll pay, itemized and explained", href: "/guide/7-closing-the-deal/2-cost-breakdown/", type: "guide" },
  { title: "Closing Cost Calculator", description: "Get a personalized estimate for your province and price range", href: "/tools/closing-cost-calculator", type: "tool" },
  { title: "Book a Free Call", description: "Review your closing costs with our mortgage team", href: "/book-a-call", type: "action" }
]} />
