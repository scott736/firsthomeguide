...
- **April 2026:** The Bank of Canada's policy rate is **2.25%**, prime rate is approximately **4.45%**, typical 5-year fixed mortgage rates are around **4.0% to 4.3%**, and 5-year variable rates are in the **3.95% to 4.25%** range. The rate-cut cycle has largely stabilized.
