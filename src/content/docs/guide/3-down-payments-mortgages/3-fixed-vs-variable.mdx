...
<AEOAnswerBox
  ...
  bullets={[
    "Fixed: rate locked for full term, predictable payments, higher initial rate",
    "Variable: rate changes with Bank of Canada, historically cheaper, payment can increase",
    "ARM vs VRM: adjustable-rate changes payments; variable-rate changes amortization",
    "Breaking a fixed mortgage early costs more (IRD penalty vs. 3-month interest)",
  ]}
/>
...
Fixed rates are set by lenders based primarily on the **Government of Canada bond yields** (specifically the [5-year bond](https://www.bankofcanada.ca/rates/) for 5-year fixed rates). When bond yields go up, fixed mortgage rates tend to go up, and vice versa.
...
With a variable rate mortgage, your interest rate **fluctuates based on the [Bank of Canada's](https://www.bankofcanada.ca/rates/) overnight lending rate**. When the Bank of Canada changes its key interest rate (typically at one of its eight scheduled announcement dates per year), your mortgage rate adjusts accordingly.
...
- **2022-2023:** The [Bank of Canada](https://www.bankofcanada.ca/rates/) raised rates aggressively from 0.25% to 5.00% to combat inflation. Variable-rate borrowers saw their rates more than triple. Many hit trigger rates and faced payment shock.
...
- **Early 2026:** The Bank of Canada has held its policy rate at **2.25%** through its January and March 2026 decisions, with bond markets pricing a high probability of another hold at the April 29, 2026 meeting. Prime rate sits at **4.45%**. The best 5-year fixed rates available through brokers are around **4.04%–4.29%**, having drifted up from roughly 3.79% in February as Government of Canada 5-year bond yields rose on US tariff concerns. The best 5-year variable rates are roughly **3.30%–3.35%** — currently meaningfully below fixed.

This recent cycle illustrates both the upside and the downside of variable rates in dramatic fashion. The borrowers who benefited most from variable rates during this period were those who started variable in 2020, then locked in to a fixed rate in early 2022 before the rate hikes began. The borrowers who were hurt most were those who took variable rates in 2021-2022, just before the sharpest rate increases in decades. With BoC holding steady in 2026, the immediate upside for new variable borrowers comes from the gap to fixed; the downside risk is renewed inflation forcing the BoC back into hiking mode.
...
- You are unlikely to sell or break your mortgage before the term ends — use a [mortgage calculator](/tools/mortgage-calculator/) to compare your total costs under different scenarios
...
**Sources:** [Bank of Canada — Interest Rates](https://www.bankofcanada.ca/rates/) · [FCAC — Mortgages](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html)
