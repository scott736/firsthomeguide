...
The insurance <GlossaryTooltip client:load term="premium" definition="The cost of mortgage default insurance, ranging from 2.8% to 4.0% of the mortgage amount, typically added to the mortgage balance." /> is calculated as a **percentage of the mortgage amount** (not the purchase price). The rate depends on the size of your down payment relative to the purchase price:
