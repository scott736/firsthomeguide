...
description: "Learn when mortgage default insurance is required in Canada, how premium rates work (2.4%–4.0%), the three insurers (CMHC, Sagen, Canada Guaranty), and how to minimize costs."
sidebar:
  order: 2
---
...
<AEOAnswerBox
  ...
  answer="Mortgage default insurance is required in Canada when your down payment is less than 20% of the purchase price. The premium ranges from 2.4% to 4.0% of the mortgage amount and is typically added to your mortgage balance. Three insurers offer this product: CMHC, Sagen, and Canada Guaranty."
  bullets={[
    "Required when down payment is less than 20%",
    "Premium: 2.4% (15–19.99% down) to 4.0% (5–9.99% down)",
...
The insurance <GlossaryTooltip client:load term="premium" definition="The cost of mortgage default insurance, ranging from 2.8% to 4.0% of the mortgage amount, typically added to the mortgage balance." /> is calculated as a **percentage of the mortgage amount** (not the purchase price). The rate depends on the size of your down payment relative to the purchase price (see [CMHC's premium rate schedule](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance/mortgage-loan-insurance-premiums)):
