...
1. **You do not know what you do not know** — A good broker educates you on down payment rules, insurance costs, the stress test, government programs, and the difference between mortgage products. This education is especially valuable when you are navigating the process for the first time.
