...
Canada's six major banks — **RBC, TD, BMO, Scotiabank, CIBC, and National Bank** — are the most common mortgage providers in the country. Together, they hold the majority of Canadian residential mortgages. For many buyers, the bank is the default choice simply because it is familiar.
