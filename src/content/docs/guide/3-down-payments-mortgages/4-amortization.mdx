...
If your down payment is less than 20% and you need [mortgage default insurance](/guide/3-down-payments-mortgages/2-cmhc-insurance/), the rules for 30-year amortization are:

- **First-time buyers (any home type — resale or new construction):** 30-year amortization is available, effective **December 15, 2024**.
- **All buyers of newly built homes:** 30-year amortization is available on insured mortgages, effective December 15, 2024.
- **Non-first-time buyers purchasing a resale home:** The maximum insured amortization remains 25 years.

**Note:** Insured mortgages that use a 30-year amortization carry a **+0.20% surcharge** on the CMHC insurance premium. For example, a 5% down payment with a 30-year amortization has a premium of 4.20% instead of 4.00%.
