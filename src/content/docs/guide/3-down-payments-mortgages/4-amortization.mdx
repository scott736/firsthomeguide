...
Let's look at concrete numbers to see the real difference. These examples assume a fixed interest rate for the entire amortization period (in practice, your rate will change at each renewal, but this illustrates the structural difference).
