...
**What they review:**
- **[Notices of Assessment](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/notice-assessment-understand.html) (NOAs)** from the CRA for the past 2 years
...
4. **Make a larger down payment.** Putting down 10% to 20% or more significantly reduces the lender's risk and opens the door to more lending programs, including BFS options. A 20% down payment also eliminates [CMHC insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance), saving you thousands.
...
<KnowledgeQuiz
  client:visible
  moduleNumber={3}
  moduleName="Down Payments & Mortgages"
  questions={[
    {
      question: "What is the minimum down payment on a $600,000 home in Canada?",
      options: ["$30,000 (5%)", "$35,000", "$40,000", "$60,000 (10%)"],
      correctIndex: 1,
      explanation: "It's 5% on the first $500K ($25,000) plus 10% on the next $100K ($10,000) = $35,000."
    },
    {
      question: "When is CMHC mortgage insurance required?",
      options: ["Always", "Down payment under 20%", "Down payment under 10%", "Only for condos"],
      correctIndex: 1,
      explanation: "Mortgage default insurance is required when your down payment is less than 20%."
    },
    {
      question: "What does a mortgage pre-approval guarantee?",
      options: ["You'll get the house", "A rate hold for 90-120 days", "Your closing costs", "The home's value"],
      correctIndex: 1,
      explanation: "Pre-approval gives you a rate hold (typically 90-120 days) but is not a final mortgage commitment."
    },
  ]}
/>

<MilestoneCelebration client:visible moduleNumber={3} moduleName="Down Payments & Mortgages" totalModules={8} nextModuleHref="/guide/4-government-programs/1-federal-programs/" nextModuleName="Government Programs" />

---

---

**Sources:** [FCAC — Mortgages](https://www.canada.ca/en/financial-consumer-agency/services/mortgages.html) · [CMHC — Mortgage Loan Insurance](https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance) · [CMHC — Homebuying Guide](https://www.cmhc-schl.gc.ca/consumers/home-buying)
