...
When you apply for a mortgage, your lender uses two key ratios to determine how much you can afford to borrow. These are the **Gross Debt Service (GDS) ratio** and the **Total Debt Service (TDS) ratio**. Understanding these ratios gives you the ability to estimate your borrowing power — try our [affordability calculator](/tools/affordability-calculator/) — before you even talk to a lender — and to take steps to improve your position if your ratios are too high.
