...
const TABS_DATA = [
  {
    id: 'programs',
    title: 'Province-by-province program breakdown',
    description:
  ...
  {
    id: 'journey',
    title: 'Start-to-finish guided journey',
    description:
      ...
      <div className="flex flex-col justify-between gap-3">
        <div className="space-y-6 text-balance lg:max-w-lg">
          ...
          <p className="text-muted-foreground mt-3 text-lg leading-snug">
            Government PDFs are outdated. Bank guides push products. Reddit
            threads are overwhelming. This is the structured, neutral
            alternative.
          </p>
        </div>
        {/* Tabs Section */}
