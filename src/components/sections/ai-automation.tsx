...
import { BadgeCheck, DollarSign, FileText, Home, MapPin, Sparkles } from 'lucide-react';
...
const cards = [
  {
    id: 'fhsa',
    title: 'FHSA + RRSP Strategy',
    subtitle: 'Up to $100,000 per couple tax-free',
    icon: DollarSign,
  ...
  },
  {
    ...
    subtitle: 'Documents, stress test, and timeline',
    icon: FileText,
  ...
  },
  {
    ...
    subtitle: 'Land transfer rebates, down payment help',
    icon: MapPin,
  ...
  },
  {
    id: 'closing',
    title: 'Closing Costs',
    subtitle: 'Budget 3-5% of purchase price',
    icon: Home,
            ...
            <div className="relative z-10 flex items-center gap-2 px-5 py-4 text-xs lg:text-sm">
              ...
              <div>
                ...
                <span className="text-accent-foreground">
                  I&apos;m saving for my first home in Ontario — what programs do I qualify for?
                </span>
              </div>
            </div>
          </motion.div>
          <h2 className="text-4xxl leading-tight tracking-normal md:text-5xl">
            From savings accounts to closing day —{' '}
            <span className="text-gradient">all connected</span>
          </h2>
          <p className="text-muted-foreground mt-2 max-w-xl text-lg leading-snug">
            Every module builds on the last. Your FHSA strategy affects your
            down payment, which affects your mortgage insurance, which affects
            your closing costs. We connect all the dots.
          </p>
        </div>
