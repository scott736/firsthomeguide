import { BookOpen, Calculator, FileText, MapPin, Shield } from 'lucide-react';
...
const highlights = [
  ...
  { icon: Shield, label: 'No Product Upsell' },
];
  ...
  return (
    <section className="section-padding container !pt-0 text-center">
      <p className="text-muted-foreground tracking-normal">
        Built on data from CMHC, FCAC, CRA, and provincial housing authorities
      </p>
