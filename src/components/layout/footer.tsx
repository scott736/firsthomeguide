      ...
      <div className="container text-center">
        ...
        <div className="mx-auto flex max-w-sm justify-center gap-4.5">
          ...
          <Button
            ...
            asChild
          >
            <a href="/guide/4-government-programs/1-federal-programs/">Explore by Province</a>
          </Button>
        </div>

        <p className="mt-3 text-sm">Free. Comprehensive. No product upsell.</p>
      </div>

      <div className="container mt-20 flex flex-col-reverse justify-between gap-8 text-xs lg:mt-30 lg:flex-row">
        <div className="flex items-center justify-between gap-2">
          <p className="">
            © {new Date().getFullYear()} FirstHomeGuide.ca — Built for Canadian home buyers.
          </p>
        </div>
